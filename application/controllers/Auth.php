...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        $this->form_validation->set_rules('email', 'Email', 'required|trim|valid_email|is_unique[user.email]', [
            ...
            'is.unique' => 'This email has already registered!'
        ]);
...
*/
            ...
            /*
            $this->input->post('user_token', $user_token);
...
*/
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => 'webkresno@gmail.com',
            'smtp_pass' => 'ijz235nh79',
            'smtp_port' => 465,
            'mailtype' => 'html',
            'charset' => 'utf-8',
            'newline' => "\r\n"
        ...
        $this->email->from('webkresno@gmail.com', 'simple web');
